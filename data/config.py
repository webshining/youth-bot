...
MONGO_HOST = env.str("MONGO_HOST", None)
MONGO_PORT = env.int("MONGO_PORT", None)
MONGO_USER = env.str("MONGO_USER", None)
MONGO_PASS = env.str("MONGO_PASS", None)

MONGO_URL = env.str('MONGO_URL', "mongodb://localhost:27017/")
if MONGO_HOST and MONGO_PORT and MONGO_USER and MONGO_PASS:
